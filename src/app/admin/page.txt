...
const CATEGORIES = ["Adventure", "Cultural", "Nature"];
const REGIONS = ["Ghardaïa", "Timimoun", "Béchar", "Djanet", "El Goléa", "Tamanrasset", "Biskra"];
const LOCATIONS = ["Ghardaïa", "Timimoun", "Béchar", "Djanet", "El Goléa", "Tamanrasset", "Biskra"];
            ...
            <form onSubmit={handleHotelSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) => setHotel({ ...hotel, featured: e.target.checked })}
                  className="accent-brand-brown"
                />
